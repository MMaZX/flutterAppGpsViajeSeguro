...
abstract interface class AbstractMaps extends Widget {
  const AbstractMaps({super.key});
...
class LocationMapsContent extends StatefulWidget implements AbstractMaps {
  @override
  ...
  const LocationMapsContent({super.key});

  @override
  State<StatefulWidget> createState() => LocationMapsContentState();
}

class LocationMapsContentState extends State<LocationMapsContent> {
  LocationMapsContentState();
